...
#define BUILD_PIXEL(R,G,B) (BUILD_PIXEL_RGB5551(R, G, B))
#define BUILD_PIXEL2(R,G,B) (BUILD_PIXEL2_RGB5551(R, G, B))
#define DECOMPOSE_PIXEL(Pixel,R,G,B) (DECOMPOSE_PIXEL_RGB5551(Pixel, R,G,B))
